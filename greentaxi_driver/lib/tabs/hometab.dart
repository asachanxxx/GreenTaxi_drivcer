...
class _HomeTabState extends State<HomeTab> {
  ...
  void GoOnline(){
    ...
    print('GoOnline : currentFirebaseUser.uid-> ' + currentFirebaseUser.uid + ' currentPosition.latitude-> ' + currentPosition.latitude.toString() +' currentPosition.longitude-> ' + currentPosition.longitude.toString());
